            ...
            <div class="row clearfix">
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="block-header">
                        <h2>Data Perubahan NPSN</h2>
                    </div>
                        <form action="{{url('/data_perubahan_npsn')}}" method="get">
                          @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel5">
                  <div class="custom-title-wrap bar-warning">
                      <div class="custom-title">Form Import Data Perubahan NPSN</div>
                  </div>
                </h5>
            ...
            <div class="modal-body">
              <form action="{{url('/importDataPerubahanNPSN')}}" method="post" enctype="multipart/form-data">
                  @csrf
