            ...
            <div class="card">
                <div class="header">
                                <div class="block-header">
                                    <h2>Data Nilai Mapel UN Skala 4 SMK</h2>
                                </div>
                                <form action="{{url('/data_nilai_skala_4_smk')}}" method="get">
                                  @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel5">
                  <div class="custom-title-wrap bar-warning">
                      <div class="custom-title">Form Import Data Nilai Mapel UN SMK Skala 4</div>
                  </div>
                </h5>
            ...
            <div class="modal-body">
              <form action="{{url('/importNilaiSkala4SMK')}}" method="post" enctype="multipart/form-data">
                  @csrf
