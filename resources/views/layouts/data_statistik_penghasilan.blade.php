            ...
            <div class="card">
                <div class="header">
                                <div class="block-header">
                                    <h2>Data Statistik Penghasilan Ayah</h2>
                                </div>
                                <form action="{{url('/data_statistik_penghasilan')}}" method="get">
                                  @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel5">
                  <div class="custom-title-wrap bar-warning">
                      <div class="custom-title">Form Import Data Statistik Penghasilan</div>
                  </div>
                </h5>
            ...
            <div class="modal-body">
              <form action="{{url('/importDataStatistikPenghasilan')}}" method="post" enctype="multipart/form-data">
                  @csrf
