            ...
            <div class="card">
                <div class="header">
                                <div class="block-header">
                                    <h2>Data Nilai Mapel UN Skala 100 SMA</h2>
                                </div>
                                <form action="{{url('/data_nilai_skala_100_sma')}}" method="get">
                                  @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel5">
                  <div class="custom-title-wrap bar-warning">
                      <div class="custom-title">Form Import Data Nilai Mapel UN SMA Skala 100</div>
                  </div>
                </h5>
            ...
            <div class="modal-body">
              <form action="{{url('/importNilaiSkala100SMA')}}" method="post" enctype="multipart/form-data">
                  @csrf
