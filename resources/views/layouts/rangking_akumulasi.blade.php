            ...
            <div class="card">
                <div class="header">
                                <div class="block-header">
                                    <h2>Rangking Akumulasi</h2>
                                </div>
                        <form action="{{url('/ranking_akumulasi')}}" method="get">
                          @csrf
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Jumlah Siswa 1-5</th>
                                        <th>Indeks Mapel UN 1-5</th>
                                        <th>Rangking Mapel UN 1-5</th>
                                        <th>Percentile</th>
                                ...
                                @foreach($ranking as $d)
                                    <tr>
                                        ...
                                        <td>{{$d->jumlah_siswa_1_5}}</td>
                                        <td>{{$d->indeks_mapel_un_1_5}}</td>
                                        <td>{{$d->ranking_mapel_un_1_5}}</td>
                                        <td>{{$d->percentile}}</td>
                                    </tr>
                                    <?php
                                    $i++
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel5">
                  <div class="custom-title-wrap bar-warning">
                      <div class="custom-title">Form Import Data Ranking Akumulasi</div>
                  </div>
                </h5>
            ...
            <div class="modal-body">
              <form action="{{url('/importRangkingAkumulasi')}}" method="post" enctype="multipart/form-data">
                  @csrf
