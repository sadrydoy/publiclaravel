            ...
            <div class="card">
                <div class="header">
                                <div class="block-header">
                                    <h2>Rangking Semester</h2>
                                </div>
                        <form action="{{url('/ranking_semester')}}" method="get">
                          @csrf
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Jenis Kelas</th>
                                        <th>Jumlah Siswa</th>
                                        <th>Indeks Mapel UN</th>
                                        <th>Rangking Mapel UN</th>
                                ...
                                @foreach($semester as $d)
                                    <tr>
                                        ...
                                        <td>{{$d->indeks_mapel_un}}</td>
                                        <td>{{$d->ranking_mapel_un}}</td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel5">
                  <div class="custom-title-wrap bar-warning">
                      <div class="custom-title">Form Import Data Ranking Semester</div>
                  </div>
                </h5>
            ...
            <div class="modal-body">
              <form action="{{url('/importRangkingSemester')}}" method="post" enctype="multipart/form-data">
                  @csrf
