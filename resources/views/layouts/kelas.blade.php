        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                                ...
                                <form action="{{url('/data_kelas')}}" method="get">
                                  @csrf
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>ID Kelas</th>
                                        <th>Tahun Kelas DIselenggarakan</th>
                                        <th>Tingkat</th>
                                        <th>Nama Kelas</th>
                                ...
                                @foreach($kelas as $d)
                                    <tr>
                                        <th>{{$i}}</th>
                                        <td>{{$d->id_kelas}}</td>
                                        <td>{{$d->tahun_kelas_diselenggarakan}}</td>
                                        <td>{{$d->tingkat}}</td>
                                        <td>{{$d->nama_kelas}}</td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel5">
                  <div class="custom-title-wrap bar-warning">
                      <div class="custom-title">Form Import Data Kelas</div>
                  </div>
                </h5>
            ...
            <div class="modal-body">
              <form action="{{url('/importDataKelas')}}" method="post" enctype="multipart/form-data">
                  @csrf
