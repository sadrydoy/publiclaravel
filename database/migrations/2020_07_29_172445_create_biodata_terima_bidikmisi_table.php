...
class CreateBiodataTerimaBidikmisiTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('biodata_terima_bidikmisi', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('biodata_terima_bidikmisi');
    }
}
